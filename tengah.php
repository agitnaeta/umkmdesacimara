...
elseif(
     $_GET['module']     =='client'
     or  $_GET['module'] =='register'
     or  $_GET['module'] =='page_history'
     or  $_GET['module'] =='history_pembelian'
     or  $_GET['module'] =='client_logout'

){
  include 'login/modul/mod_client/client.php';
  // echo $_GET['module'];
}
    ...
    if(isset($_SESSION['client'])){
      $client = (object)$_SESSION['client'];
        ...
        echo "<div class='center_title_bar'>Data Pembeli</div>";
          ...
          <table>
          <tr><td>Nama</td><td> : <input type=text name=nama size=30 value=".$client->nama_kustomer."></td></tr>
          <tr><td>Alamat Lengkap</td><td> : <input type=text name=alamat size=60 value=".$client->alamat."></td></tr>
          <tr><td>Telpon/HP</td><td> : <input type=text name=telpon value=".$client->telpon."></td></tr>
      ...
      echo "</select> <br /><br />*)  Apabila tidak terdapat nama kota tujuan Anda, pilih <b>Lainnya</b>
        ...
        $_SESSION['relogin']='Anda Harus Login Dahulu';
...
mysql_query("INSERT INTO orders(iduser,nama_kustomer, alamat, telpon, email, tgl_order, jam_order, id_kota) 
             VALUES('$iduser','$nama','$alamat','$telpon','$_POST[email]','$tgl_skrg','$jam_skrg','$_POST[kota]')");
